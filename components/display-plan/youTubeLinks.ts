export const youtubeLinks = [
  // Push-Ups Variations
  {
    keywords: ["push-up", "standard push-up", "chest push-up"],
    url: "https://www.youtube.com/watch?v=IODxDxX7oi4",
  }, // Standard Push-Up Tutorial
  {
    keywords: ["diamond push-up", "triceps push-up", "push-up variation"],
  ...
  // Squats Variations
  {
    keywords: ["bodyweight squat", "bodyweight squats", "air squat"],
  ...
  // Lunges Variations
  {
    keywords: ["reverse lunge", "walking lunge", "lunges"],
  ...
  {
    keywords: ["romanian deadlift", "deadlift", "strength deadlift"],
  ...
  // Plank Variations
  {
    keywords: ["side plank", "forearm plank", "plank exercise"],
    url: "https://www.youtube.com/watch?v=pSHjTRCQxIw",
  }, // Plank Tutorial
  {
    keywords: ["side plank core", "core strength", "side core"],
  ...
  // Biceps & Triceps
  {
    keywords: ["bicep curl", "dumbbell curl", "arms workout"],
    url: "https://www.youtube.com/watch?v=kwG2ipFRgfo",
  }, // Bicep Curl
  {
    keywords: ["tricep dip", "triceps exercises", "arm workout"],
  ...
  {
    keywords: ["hiit", "interval training", "full body hiit"],
